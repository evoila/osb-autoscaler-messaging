...
public final class ProtobufHttpMetricWrapper {
  ...
  public  static final class ProtoHttpMetric extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ProtobufHttpMetricWrapper.internal_static_autoscaler_ProtoHttpMetric_descriptor;
    }

    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return ProtobufHttpMetricWrapper.internal_static_autoscaler_ProtoHttpMetric_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ProtobufHttpMetricWrapper.ProtoHttpMetric.class, ProtobufHttpMetricWrapper.ProtoHttpMetric.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof ProtobufHttpMetricWrapper.ProtoHttpMetric)) {
        return super.equals(obj);
      }
      ProtobufHttpMetricWrapper.ProtoHttpMetric other = (ProtobufHttpMetricWrapper.ProtoHttpMetric) obj;
    ...
    public static ProtobufHttpMetricWrapper.ProtoHttpMetric parseFrom(
    ...
    public static ProtobufHttpMetricWrapper.ProtoHttpMetric parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ProtobufHttpMetricWrapper.ProtoHttpMetric parseFrom(
    ...
    public static ProtobufHttpMetricWrapper.ProtoHttpMetric parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ProtobufHttpMetricWrapper.ProtoHttpMetric parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ProtobufHttpMetricWrapper.ProtoHttpMetric parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ProtobufHttpMetricWrapper.ProtoHttpMetric prototype) {
    ...
    public static final class Builder extends
        ...
        ProtobufHttpMetricWrapper.ProtoHttpMetricOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ProtobufHttpMetricWrapper.internal_static_autoscaler_ProtoHttpMetric_descriptor;
      }
      ...
      public ProtobufHttpMetricWrapper.ProtoHttpMetric getDefaultInstanceForType() {
        return ProtobufHttpMetricWrapper.ProtoHttpMetric.getDefaultInstance();
      }

      public ProtobufHttpMetricWrapper.ProtoHttpMetric build() {
        ProtobufHttpMetricWrapper.ProtoHttpMetric result = buildPartial();
      ...
      public ProtobufHttpMetricWrapper.ProtoHttpMetric buildPartial() {
        ProtobufHttpMetricWrapper.ProtoHttpMetric result = new ProtobufHttpMetricWrapper.ProtoHttpMetric(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ProtobufHttpMetricWrapper.ProtoHttpMetric) {
          return mergeFrom((ProtobufHttpMetricWrapper.ProtoHttpMetric)other);
        } else {
      ...
      public Builder mergeFrom(ProtobufHttpMetricWrapper.ProtoHttpMetric other) {
        if (other == ProtobufHttpMetricWrapper.ProtoHttpMetric.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ProtobufHttpMetricWrapper.ProtoHttpMetric parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ProtobufHttpMetricWrapper.ProtoHttpMetric) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final ProtobufHttpMetricWrapper.ProtoHttpMetric DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ProtobufHttpMetricWrapper.ProtoHttpMetric();
    }

    public static ProtobufHttpMetricWrapper.ProtoHttpMetric getDefaultInstance() {
